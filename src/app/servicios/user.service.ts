...
export class UserService {
 ...
 /**
  ...
  roleA(id):Observable<any>{
    return this._http.put(this.url+"userRoleA/"+id,{headers:this.headers});
  }
  roleB(id):Observable<any>{
    return this._http.put(this.url+"userRoleB/"+id,{headers:this.headers});
  }
  roleO(id):Observable<any>{
    return this._http.put(this.url+"userRoleO/"+id,{headers:this.headers});
  }
